...
{
    // Lista enlazada a la UI
    private List<ConcertModel> _filteredConcerts;

    /// <summary>
    /// Constructor de la página. Inicializa los componentes visuales y carga la información de los conciertos.
    /// </summary>
    /// <author>Emmanuel Baltazar López</author>
    /// <date>27/02/2026</date>
    /// <version>1.1</version>
    ...
    /// <summary>
    /// Método auxiliar que instancia la lista de conciertos con su información detallada
    /// y la asigna como fuente de datos para el control visual.
    /// </summary>
    /// <author>Emmanuel Baltazar López</author>
    /// <date>27/02/2026</date>
    /// <version>1.1</version>
    ...
    {
        var conciertos = new List<ConcertModel>
        {
        ...
        _filteredConcerts = conciertos;
        concertList.ItemsSource = _filteredConcerts;
    }

    /// <summary>
    /// Manejador de evento que se dispara cuando el usuario selecciona un concierto de la lista.
    ...
    {
        if (e.CurrentSelection.FirstOrDefault() is ConcertModel selectedConcert)
        {
            // Navegamos a la página de detalle enviando el objeto seleccionado al constructor
            await Navigation.PushAsync(new DetailConcertsPage(selectedConcert));
